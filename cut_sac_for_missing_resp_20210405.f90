...
inquire(file='resp_missing.log',exist=ext)
if(.not.ext)stop 'no missing log found!'

open(50,file='resp_missing.log')
do iresp=1,nrmax                               ! loop over the file
   read(50,*,end=60,err=60)iy,id
